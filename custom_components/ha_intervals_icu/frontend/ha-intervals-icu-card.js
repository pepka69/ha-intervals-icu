...
function pt(i) {
  ...
  return e === "planned_today_sport" || e === "last_activity_type" || t.endsWith("_planned_today_sport") || t.endsWith("_last_activity_type") || !!Te[i.state];
}
function gt(i) {
  return [...new Set(
    Me(i).filter(
      ...
      ([s, a]) => u`
        ...
        <details class="about-panel">
          <summary>
            ...
            <span class="about-version">v${$t}</span>
          </summary>
